...
local mappings = {
  ...
  l = {
    ...
    e = { "<cmd>LspSettings buffer local<cr>", "Open LSP settings file for current buffer (this project)" },
    E = { "<cmd>LspSettings buffer<cr>", "Open LSP settings file for current buffer (global)" },
